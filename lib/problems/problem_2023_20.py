# stolen from
# https://github.com/morgoth1145/advent-of-code/blob/f64a24a7340c9b9a9834e2109bdb1c6924bc9ea7/2023/20/solution.py
# my ocaml solution kept stack overflowing
...
class Network:
    ...
    def num_cycles_until_low_output(self):
        ...
        assert all(self._connections[leaf][0] == "&" for leaf in subtree_leaves)
...
with open("inputs/2023/20.txt") as file:
